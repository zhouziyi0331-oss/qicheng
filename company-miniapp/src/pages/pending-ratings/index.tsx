  ...
  return (
    <View className="pending-ratings-page">
      ...
      <View className="header">
        ...
        <Text className="subtitle">评价学生，建立良好的合作关系</Text>
      </View>
      ...
      >
        {loading && tasks.length === 0 ? (
          ...
          <View className="empty">
            ...
            <Text className="empty-hint">完成任务后可以评价学生</Text>
          </View>
        ) : (
          tasks.map(task => (
            <View key={task.id} className="task-item">
              ...
              <View className="student-info">
                <View className="avatar">
                  {task.other_party_avatar ? (
                    ...
                    <Text className="avatar-text">学</Text>
                  )}
                </View>
                <View className="info">
                  <Text className="student-name">{task.other_party_nickname}</Text>
              ...
              <View className="task-info">
                ...
                <View className="task-meta">
                  <Text className="price">¥{task.company_price}</Text>
      ...
      {tasks.length > 0 && (
        <View className="footer-tip">
          <Text className="tip-text">💡 及时评价有助于学生成长</Text>
        </View>
      )}
    </View>
  );
