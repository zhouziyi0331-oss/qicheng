...
export default function TaskAcceptPage() {
          ...
          {loading ? (
            ...
            <View className="task-list">
              {tasks.map((task, index) => (
                <View
                  key={task.id}
                  className={`grab-card ${task.urgency === 'urgent' ? 'urgent' : 'normal'}`}
                  ...
                  <View className="grab-card-body">
                    ...
                    <View className="task-info-grid">
                      <View className="info-item">
                        <Text className="info-value">¥ {task.budget}</Text>
              ...
              <View className="divider-section">
                <Text className="divider-text">以上为本次推送全部任务</Text>
              </View>
            </View>
          )}
        </View>
              ...
              <View className="task-summary-card">
                ...
                <View className="summary-info-grid">
                  <View className="summary-info-item">
                    <Text className="summary-info-value">¥ {selectedTask.budget}</Text>
