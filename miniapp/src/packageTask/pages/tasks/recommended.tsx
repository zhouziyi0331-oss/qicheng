...
import { studentRecommendationAPI, taskTranslationAPI } from '../../../services/api';
...
export default function RecommendedTasks() {
  ...
  const loadRecommendedTasks = async (isRefresh = false) => {
    try {
      ...
      const res = await studentRecommendationAPI.getRecommendedTasks();
  ...
  const handleViewTask = (taskId: string) => {
    Taro.navigateTo({
      url: `/packageTask/pages/tasks/detail?id=${taskId}&from=recommended`
    });
  };
