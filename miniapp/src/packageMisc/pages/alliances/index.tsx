...
export default function Alliances() {
  ...
  const loadAlliances = async () => {
    try {
      ...
      const response = await allianceAPI.getStudentAlliances(studentId)
  ...
  const loadInvitations = async () => {
    try {
      const studentId = Taro.getStorageSync('userId')
      const response = await allianceAPI.getPendingInvitations(studentId)
  ...
  const handleRespondInvitation = async (invitationId: string, accept: boolean) => {
    try {
      await allianceAPI.respondToInvitation(invitationId, accept)
