...
const seedDatabase = async () => {
    try {
        ...
        const users = await User_1.User.insertMany(testUsers);
        ...
        const projects = await PracticeProject_1.PracticeProject.insertMany(testProjects);
        ...
        const testReports = [
            {
                ...
                replicability: {
                    ...
                    industries: [
                        { name: '护肤品牌', icon: '◆', level: 'high' },
                        { name: '健身博主', icon: '▲', level: 'high' },
                        { name: '家居品牌', icon: '○', level: 'medium' },
                        { name: '教育机构', icon: '◈', level: 'medium' },
                        { name: '宠物博主', icon: '✦', level: 'high' }
                    ]
                },
                learned: {
            ...
            },
            {
                ...
                replicability: {
                    ...
                    industries: [
                        { name: '瑜伽教练', icon: '◆', level: 'high' },
                        { name: '营养师', icon: '▲', level: 'high' },
                        { name: '心理咨询师', icon: '○', level: 'medium' },
                        { name: '理财规划师', icon: '◈', level: 'medium' }
                    ]
                },
                learned: {
            ...
            },
            {
                ...
                replicability: {
                    ...
                    industries: [
                        { name: 'B2B企业官网', icon: '◆', level: 'high' },
                        { name: 'SaaS产品站', icon: '▲', level: 'high' },
                        { name: '品牌展示站', icon: '○', level: 'high' },
                        { name: '电商官网', icon: '◈', level: 'medium' }
                    ]
                },
                learned: {
        ...
        const reports = await PracticeReport_1.PracticeReport.insertMany(testReports);
        ...
        const collaborations = await Collaboration_1.Collaboration.insertMany(testCollaborations);
