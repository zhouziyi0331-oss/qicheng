...
const seedCompletedProjects = async () => {
    try {
        ...
        // 获取一些available项目
        const availableProjects = await RealProject_1.RealProject.find({ status: 'available' }).limit(5);
        ...
        for (let i = 0; i < Math.min(3, availableProjects.length); i++) {
            ...
            project.projectNumber = await RealProject_1.RealProject.countDocuments({
                userId: user._id,
...
//# sourceMappingURL=seedCompletedProjects.js.map