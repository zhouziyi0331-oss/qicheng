 ...
 */
router.get('/my-access-logs', authenticateToken, async (req: Request, res: Response) => {
  try {
    const user = (req as any).user;
    const limit = parseInt(req.query.limit as string) || 50;
 ...
 */
router.post('/unlock-contact/request', authenticateToken, async (req: Request, res: Response) => {
  try {
    const user = (req as any).user;
 ...
 */
router.post('/unlock-contact/approve', authenticateToken, async (req: Request, res: Response) => {
  try {
    const user = (req as any).user;
 ...
 */
router.post('/unlock-contact/reject', authenticateToken, async (req: Request, res: Response) => {
  try {
    const user = (req as any).user;
    const { studentId, companyId } = req.body;
 ...
 */
router.get('/unlock-contact/:studentId/:companyId', authenticateToken, async (req: Request, res: Response) => {
  try {
    const user = (req as any).user;
    const { studentId, companyId } = req.params;
 ...
 */
router.get('/unlock-status/:studentId/:companyId', authenticateToken, async (req: Request, res: Response) => {
  try {
    const user = (req as any).user;
    const { studentId, companyId } = req.params;
 ...
 */
router.get('/my-unlock-requests', authenticateToken, async (req: Request, res: Response) => {
  try {
    const user = (req as any).user;
