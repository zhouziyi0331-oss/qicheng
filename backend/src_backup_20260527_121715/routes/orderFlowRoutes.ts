 ...
 */
router.post('/:orderId/accept', authenticateToken, async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/:orderId/submit', authenticateToken, async (req: Request, res: Response) => {
  try {
    const { orderId } = req.params;
 ...
 */
router.post('/:orderId/request-revision', authenticateToken, async (req: Request, res: Response) => {
  try {
    const { orderId } = req.params;
 ...
 */
router.post('/:orderId/complete', authenticateToken, async (req: Request, res: Response) => {
  try {
    const { orderId } = req.params;
 ...
 */
router.post('/:orderId/activity', authenticateToken, async (req: Request, res: Response) => {
  try {
    const { orderId } = req.params;
    const userId = (req as any).user?.id;
