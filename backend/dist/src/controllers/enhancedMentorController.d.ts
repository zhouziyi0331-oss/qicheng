...
export declare class EnhancedMentorController {
     ...
     */
    initProject(req: Request, res: Response): Promise<void>;
    /**
     * 获取用户的项目列表
     ...
     */
    getProjectDetail(req: Request, res: Response): Promise<void>;
    /**
     * 任务拆解引导
     * POST /api/v1/mentor/projects/:projectId/decompose
     */
    guideDecomposition(req: Request, res: Response): Promise<void>;
    /**
     * 评估任务拆解
     ...
     */
    saveReflectionLog(req: Request, res: Response): Promise<void>;
    /**
     * 切换导师模式
     * POST /api/v1/mentor/switch-mode
     */
    switchMode(req: Request, res: Response): Promise<void>;
    /**
     * 获取导师使用统计
