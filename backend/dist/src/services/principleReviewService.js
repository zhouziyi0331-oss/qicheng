...
请审核这条回复是否符合初心标准，返回JSON格式结果。`;
            ...
            // 记录审核日志
            logger_1.default.info('AI-07 principle review completed', {
                pass: result.pass,
            ...
            logger_1.default.error('AI-07 principle review failed:', error);
...
exports.PrincipleReviewService = PrincipleReviewService;
exports.default = new PrincipleReviewService();
//# sourceMappingURL=principleReviewService.js.map