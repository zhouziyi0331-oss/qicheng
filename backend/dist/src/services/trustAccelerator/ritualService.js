...
class RitualService {
     ...
     * 生成启程证书
     */
    static async generateCertificate(unlockRecordId) {
        try {
            // 获取解锁记录
            const result = await (0, db_1.query)(`SELECT ur.*, u.nickname as student_name, cp.company_name,
...
//# sourceMappingURL=ritualService.js.map