...
async function wechatNotify(req, res, _next) {
    try {
        ...
        if (!(0, payment_1.verifyWechatSignature)(timestamp, nonce, body, signature)) {
            logger_1.default.warn('WeChat signature verification failed');
...
async function alipayNotify(req, res, _next) {
    try {
        ...
        if (!(0, payment_1.verifyAlipaySignature)(req.body, signature)) {
            logger_1.default.warn('Alipay signature verification failed');
            res.send('fail');
            return;
        }
