...
exports.maskDataByPermission = maskDataByPermission;
exports.maskArrayData = maskArrayData;
/**
 * 手机号脱敏
 * 138****0099
 */
 ...
 * 根据管理员权限决定是否脱敏
 */
function maskDataByPermission(data, adminRole, sensitiveFields = ['phone', 'email', 'id_card', 'bank_card']) {
    // 超级管理员可以看到所有数据
 ...
 * 批量脱敏数组数据
 */
function maskArrayData(dataArray, adminRole, sensitiveFields = ['phone', 'email']) {
    if (adminRole === 'super_admin') {
        return dataArray;
    }
