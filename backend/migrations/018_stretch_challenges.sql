...
CREATE INDEX IF NOT EXISTS idx_challenge_student ON stretch_challenges(student_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_challenge_status ON stretch_challenges(status);
