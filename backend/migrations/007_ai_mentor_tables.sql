...
CREATE INDEX IF NOT EXISTS idx_mentor_student ON mentor_conversations(student_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_mentor_task ON mentor_conversations(task_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_mentor_trigger ON mentor_conversations(trigger_type, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_stuck_student ON student_stuck_points(student_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_stuck_task ON student_stuck_points(task_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_stuck_unresolved ON student_stuck_points(student_id, resolved) WHERE resolved = FALSE;
...
CREATE INDEX IF NOT EXISTS idx_milestone_student ON student_milestones(student_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_milestone_type ON student_milestones(milestone_type, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_milestone_uncelebrated ON student_milestones(student_id, is_celebrated) WHERE is_celebrated = FALSE;
...
CREATE INDEX IF NOT EXISTS idx_activity_task ON student_activity_log(task_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_nudge_student_task ON mentor_nudge_log(student_id, task_id);
