...
import opcV2PersonalityRoutes from './routes/opcV2PersonalityRoutes';
import aiMentorRoutesV2 from './routes/aiMentorRoutesV2';
import assetVisualizationRoutes from './routes/assetVisualizationRoutes';
...
import opcV2Routes from './routes/opcV2Routes'; // OPC v2.0 AI画像分析系统（新版）
import mentorAutoTriggerRoutes from './routes/mentorAutoTriggerRoutes'; // AI导师自动触发系统
import semanticMatchingRoutes from './routes/semanticMatching'; // 语义匹配引擎路由
import statsRoutes from './routes/stats'; // 统计API（消除固定文案）
...
import threeStrikeRoutes from './routes/tasks/threeStrikeRoutes';
import teamRoutesNew from './routes/teamRoutes';
...
app.use('/api/v1/opc-v2', opcV2Routes); // OPC v2.0 AI画像分析系统（新版）
...
app.use('/api/v1/teams', teamsRoutes); // 组队系统（旧版）
app.use('/api/v1/community', communityRoutes); // 社区板块（旧版）

// 新增：三次审核兜底、组队、社区、大师系统（新版）
app.use('/api/v1/tasks', threeStrikeRoutes); // 三次审核兜底系统
app.use('/api/v1/teams-new', teamRoutesNew); // 组队系统（新版）
