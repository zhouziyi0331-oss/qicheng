...
class MatchingScheduler {
  ...
  async rematchAllOpenTasks(): Promise<void> {
    try {
      ...
      logger.info(`Found ${tasks.length} open tasks to rematch`);
      ...
      for (const match of matches) {
        await query(
          ...
          [
            ...
            match.match_score.skill_match_score,
            match.match_score.difficulty_match_score,
            match.match_score.domain_match_score,
            match.match_score.growth_potential_score,
            match.match_score.reliability_score,
            match.match_score.preference_score,
