 ...
 * POST /api/opc/submit
 */
export const submitOPCTest = async (req: Request, res: Response) => {
 ...
 */
export const getOPCResult = async (req: Request, res: Response) => {
 ...
 * 生成维度解读
 */
function generateInterpretations(scores: any) {
  const DIMENSION_INTERPRETATIONS: any = {
    information_processing: {
 ...
 * 生成推荐信息
 */
function generateRecommendations(personalityTag: any) {
  return {
